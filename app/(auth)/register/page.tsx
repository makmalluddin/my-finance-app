      ...
      <div className="w-full max-w-md relative z-10">
        <div className="backdrop-blur-xl bg-gray-900/50 border border-gray-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-6">
            <h1 className="text-3xl font-bold text-white mb-1">Daftar Akun</h1>
            <p className="text-gray-400">Buat akun baru untuk mulai mencatat transaksi Anda</p>
          </div>
                  ...
                  {showPassword ? (
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none"
                      ...
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                        d="M13.875 18.825A10 10 0 0112 19c-5.523 0-10-4.477-10-10 0-.91.122-1.79.35-2.625M21.65 9.375A9.958 9.958 0 0122 12c0 5.523-4.477 10-10 10-.947 0-1.865-.132-2.737-.378M4.222 4.222l15.556 15.556" />
                    </svg>
                  ) : (
                    // Eye
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none"
                      viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                        d="M1.458 12C2.732 7.943 6.815 5 12 5c5.184 0 9.268 2.943 10.542 7-1.274 4.057-5.358 7-10.542 7-5.185 0-9.268-2.943-10.542-7z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
